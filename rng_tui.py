...
class RNGCollectorApp(App):
    ...
    DataTablePanel DataTable .datatable--row {
        height: 1;
    }
    
    DataTablePanel DataTable .datatable--header {
        text-style: bold;
        color: #00ff00;
    }
    
    DataTablePanel DataTable .datatable--cursor {
        background: #333333;
    }
    ...
    /* Bottom container for DataTablePanel */
    .bottom-container {
        width: 100%;
        height: 1fr;
    }
