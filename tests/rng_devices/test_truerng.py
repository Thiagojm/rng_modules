"""
Test script for truerng module.
...
def test_get_bytes():
    ...
    from rng_devices.truerng import is_device_available, get_bytes
...
def test_get_bits():
    ...
    from rng_devices.truerng import is_device_available, get_bits
...
def test_get_exact_bits():
    ...
    from rng_devices.truerng import is_device_available, get_exact_bits
...
def test_random_int():
    ...
    from rng_devices.truerng import is_device_available, random_int
...
def test_close():
    """Test close."""
    print("Testing close...")
    from rng_devices.truerng import close
...
def main():
    """Run all tests."""
    print("\n" + "=" * 60)
    print("Testing TrueRNG Sync Methods")
    print("=" * 60 + "\n")
