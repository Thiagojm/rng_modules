"""
Async test script for truerng module.
...
def test_sync_api_still_works():
    ...
    from truerng import is_device_available, get_bytes, random_int, close
...
async def test_get_bytes_async():
    ...
    from truerng import is_device_available, get_bytes_async
...
async def test_get_bits_async():
    ...
    from truerng import is_device_available, get_bits_async
...
async def test_get_exact_bits_async():
    ...
    from truerng import is_device_available, get_exact_bits_async
...
async def test_random_int_async():
    ...
    from truerng import is_device_available, random_int_async
...
async def test_close_async():
    ...
    from truerng import close_async
...
async def main():
    """Run all async tests."""
    print("\n" + "=" * 60)
    print("Testing TrueRNG Async Methods")
    print("=" * 60 + "\n")
